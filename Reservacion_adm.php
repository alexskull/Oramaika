...
<div id="wrapper">
		...
		<header id="header">
			...
			<div class="5grid-layout">
				<div class="row">
                    ...
                    <li class="current_page_item"><a href="Reservacion_adm.php">Adm. Reservaciones </a></li>
	...
	<div id="page-wrapper" class="5grid-layout">
        ...
        $consul_Reserva="SELECT * from reserva";
        $resulS_consul_reserva=mysql_query($consul_Reserva,$link);
    ...
    <div class="3u" id="sidebar1">
          <section>
            <h2>Adm. Reservas</h2>
            <ul class="style1">
              <li><a href="Reserva_adm_modificar.php" target="ventana_iframe">Consultar Reserva</a></li>
              
            </ul>
          </section>
          
        </div><br>
      <iframe  name="ventana_iframe" src="Reserva_adm_modificar.php" width=870 height=950></iframe>
